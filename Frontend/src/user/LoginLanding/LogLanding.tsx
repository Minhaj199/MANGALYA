      ...
      <div className="w-[100%] h-full  flex">
        <div className="md:w-[20%] sm:w-[30%] w-[44%]      md:h-screen  h-[1000px]  mt-28">
          <div className="w-full  md:h-[45%] sm:h-[30%] flex    md:flex justify-center flex-col items-center">
            ...
            {planData?.name ? (
              <>
                <div className="sm:w-[85%] w-[90%]  sm:h-[250px] md:h-[250px] h-[200px] md:ml-0 ml-2  transition-all duration-500 ease-in-out hover:shadow-md hover:shadow-orange-800  bg-white shadow-xl md:flex justify-center items-center flex-col  rounded-xl ">
            ...
            {currentData?.map((el, index) => (
              ...
              >
                ...
                <div className="w-[80%] flex justify-center items-end h-[50px] ">
                  <button  onClick={(e) => handleShowProfile(e, el)} className="w-32 rounded-full h-[30px] border border-amber-900 text-amber-800 hover:bg-amber-950 hover:text-white transition-colors duration-500 ease-in-out text-sm font-medium inline-flex items-center justify-center">
